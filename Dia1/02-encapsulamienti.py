...
class Persona:
    def __init__(self, nombre,apellido,correo, password, fecha_nac):
        self.nombre = nombre
    ...
    def __encriptar_password(self,password):
        return "asdasdajsdjlfsdhhkb" + password + "asjsdajkasdj"
    
    
objPersona = Persona("Eduardo", "Cotrina", "pepe@yopmail.com","123456")
